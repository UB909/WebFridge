class Item {
  ...
  static show(id) {
    ...
    document.getElementById("itemViewImg").src = "php/getImage.php?id=" + id;
  ...
  constructor(dataRow) {
    ...
    this.domImage = $('<img id="itemImg_' + this.id + '" class="itemImg itemGreyOut" src="php/getImage.php?id=' + this.id + '" alt="' + this.name + '">');
  ...
  refreshImage() {
    this.domImage[0].setAttribute("src", 'php/getImage.php?id=' + this.id + '&time=' + new Date().getTime());
  }
}